...
const canvas = Canvas.createCanvas(326, 475);
    const ctx = canvas.getContext('2d');

    const background = await Canvas.loadImage('https://images-ext-2.discordapp.net/external/P2LwxgIitfPWrI1SsWtG0Z95IgNUTsFMZP6LhuMVDrc/https/media.discordapp.net/attachments/724181369789480960/726076495520333924/unknown.jpg');
    ...
    ctx.closePath();
    ctx.clip();
  const attachment = new Discord.MessageAttachment(canvas.toBuffer(), 'payzi_captcha.png');
